...
def likelihood(x, n, P):
    """
    Calculate the likelihood of observing x successes in n trials given probabilities P.
...
def intersection(x, n, P, Pr):
    """
    Calculate the intersection of obtaining x successes in n trials with prior beliefs.
...
def posterior(x, n, P, Pr):
    """
    Calculate the posterior probability for each hypothetical probability given the data.
    ...
    Returns:
        1D numpy.ndarray containing posterior probabilities for each probability in P
    """
    # Check if n is a positive integer
    if not isinstance(n, int) or n <= 0:
        raise ValueError("n must be a positive integer")
