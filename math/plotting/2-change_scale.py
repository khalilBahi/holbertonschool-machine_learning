...
def change_scale():
    ...
    # Time range from 0 to 28,650 years, in steps of 5730 years (half-life of C-14)
    ...
    # Calculate the fraction remaining for C-14 using the exponential decay formula
    y = np.exp((r / t) * x)
